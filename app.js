...
var url = "mongodb+srv://Claudio:claudio@cluster0.lo9wi.mongodb.net/TravelBlogDb";
...
app.post('/add', (req, res)=>{
    var {title, author, description, location, url, dateStart,dateEnd,files, tags, key}  = req.body;
    var dateObj = new Date;
    var currentDate = dateObj.toUTCString();
    date = currentDate;
    key = Date.now();
 
    var Objects = { date, title, author, description, location, url, dateStart,dateEnd,files, tags, key};
...
app.post('/edit', (req, res)=>{
    ...
    var query = {title, author, description, location, url, dateStart,dateEnd,files, tags}
